  ...
  return (
    <section className="py-12 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-4xl mx-auto rounded-xl shadow-lg border-accent/50 text-center">
          <CardHeader className="p-8">
            <div className="mx-auto bg-accent p-4 rounded-full w-fit mb-4">
          ...
          <CardContent className="p-8 pt-0 space-y-4 text-lg text-muted-foreground text-left md:text-center">
            <p>
